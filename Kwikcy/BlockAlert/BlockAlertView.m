...
- (void)addComponents:(CGRect)frame {
    if (_title)
    {
        ...
        CGSize maxSize = CGSizeMake(frame.size.width-kAlertViewBorder*2, 1000);
        
        CGRect textRect = [_title boundingRectWithSize:maxSize
...
#warning Not sure if this is correct
        ...
        CGRect textRect = [_message boundingRectWithSize:maxSize
                                               options:NSStringDrawingUsesLineFragmentOrigin
...
//                                lineBreakMode:NSLineBreakByClipping];
            ...
            CGSize size = [self frameForText:title
                         sizeWithFont:buttonFont
                    constrainedToSize:CGSizeMake(_view.bounds.size.width-kAlertViewBorder*2, 10 )
                        lineBreakMode:NSLineBreakByClipping
                    ];
