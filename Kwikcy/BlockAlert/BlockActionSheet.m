...
#warning Not sure if this is correct
            ...
            CGSize maxSize = CGSizeMake(frame.size.width-kActionSheetBorder*2, 1000);
...
//            CGSize size =  sizeWithFont:titleFont
...
{
    [self addButtonWithTitle:title color:@"red-white" block:block atIndex:-1];
}
...
{
    [self addButtonWithTitle:title color:@"pink-white-rect" block:block atIndex:-1];
}

- (void)setDestructiveButtonWithTitle:(NSString *)title atIndex:(NSInteger)index block:(void (^)())block
{
    [self addButtonWithTitle:title color:@"red-white" block:block atIndex:index];
}
...
{
    [self addButtonWithTitle:title color:@"pink-white-rect" block:block atIndex:index];
}
