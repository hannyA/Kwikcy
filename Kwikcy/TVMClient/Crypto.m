...
//key is symmetric key,
+(NSData *)encrypt:(NSData *)data key:(NSString *)key withIV:(NSData *)iv
{
//    NSData *keyData = [key dataUsingEncoding:NSUTF8StringEncoding];
   
    NSData *encrypted = [Crypto aes128EncryptData:data usingKey:[Crypto hexDecode:key] andIV:iv];
    return encrypted;
}

+(NSData*)aes128EncryptData:(NSData *)data usingKey:(NSData*)key andIV:(NSData*)iv
{
...
// Used for generating a uid, device ID
...
+ (NSData*)blockInitializationVectorOfLength
{
